...
providers: list[Provider] = [
    ...
    Provider(
        ...
        model_match=ClauseOr(or_=[ClauseContains(contains='gemini'), ClauseStartsWith(starts_with='google-tts-')]),
        ...
        models=[
            ...
            ModelInfo(
                ...
                match=ClauseEquals(equals='google-tts-neural2'),
                name='Google Cloud TTS Neural2',
                description='Google Cloud Text-to-Speech Neural2 voices use deep neural networks to produce natural-sounding, human-like speech across a wide range of languages and voices.',
                price_comments='Official rate: US$0.000016 per character (US$16 per 1 million characters) => 16 / 1000 = 0.016 per 1,000 characters. Ref: https://cloud.google.com/text-to-speech/pricing',
                pricing_source_url='https://cloud.google.com/text-to-speech/pricing#legacy-tts-models',
                provenance=Provenance(last_verified=datetime.date(2026, 8, 16)),
                prices=ModelPrice(input_kchars=Decimal('0.016')),
            ),
            ModelInfo(
                id='google-tts-polyglot',
                match=ClauseEquals(equals='google-tts-polyglot'),
                name='Google Cloud TTS Polyglot',
                description='Google Cloud Text-to-Speech Polyglot (Preview) voices enable a single voice to speak multiple languages with one multilingual model, useful for cross-lingual applications.',
                price_comments='Official rate (Polyglot Preview): US$0.000016 per character (US$16 per 1 million characters) => 16 / 1000 = 0.016 per 1,000 characters. Ref: https://cloud.google.com/text-to-speech/pricing',
                pricing_source_url='https://cloud.google.com/text-to-speech/pricing#legacy-tts-models',
                provenance=Provenance(last_verified=datetime.date(2026, 8, 16)),
                prices=ModelPrice(input_kchars=Decimal('0.016')),
            ),
            ModelInfo(
                ...
                match=ClauseEquals(equals='google-tts-standard'),
                name='Google Cloud TTS Standard',
                description='Google Cloud Text-to-Speech Standard voices are the baseline concatenative/parametric synthesis voices, available in many languages at the lowest cost tier.',
                price_comments='Official rate: US$0.000004 per character (US$4 per 1 million characters) => 4 / 1000 = 0.004 per 1,000 characters. Ref: https://cloud.google.com/text-to-speech/pricing',
                pricing_source_url='https://cloud.google.com/text-to-speech/pricing#legacy-tts-models',
                provenance=Provenance(last_verified=datetime.date(2026, 8, 16)),
            ...
            ModelInfo(
                ...
                match=ClauseEquals(equals='google-tts-studio'),
                name='Google Cloud TTS Studio',
                description='Google Cloud Text-to-Speech Studio voices are premium, high-fidelity voices designed for conversational and professional audio use cases with the most natural intonation.',
                price_comments='Official rate: US$0.00016 per character (US$160 per 1 million characters) => 160 / 1000 = 0.16 per 1,000 characters. Ref: https://cloud.google.com/text-to-speech/pricing',
                pricing_source_url='https://cloud.google.com/text-to-speech/pricing#legacy-tts-models',
                provenance=Provenance(last_verified=datetime.date(2026, 8, 16)),
            ...
            ModelInfo(
                ...
                match=ClauseEquals(equals='google-tts-wavenet'),
                name='Google Cloud TTS WaveNet',
                description='Google Cloud Text-to-Speech WaveNet voices use a deep generative model of audio to produce more natural-sounding speech than the original Standard concatenation voices.',
                price_comments='Official rate: US$0.000004 per character (US$4 per 1 million characters) => 4 / 1000 = 0.004 per 1,000 characters. Ref: https://cloud.google.com/text-to-speech/pricing',
                pricing_source_url='https://cloud.google.com/text-to-speech/pricing#legacy-tts-models',
                provenance=Provenance(last_verified=datetime.date(2026, 8, 16)),
                prices=ModelPrice(input_kchars=Decimal('0.004')),
