...
providers: list[Provider] = [
    ...
    Provider(
        ...
        models=[
            ...
            ModelInfo(
                id='standard',
                match=ClauseEquals(equals='standard'),
                name='Standard (real-time)',
                description='Faster, lower-cost operating point, streaming. Priced identically to `standard-batch`.',
                price_comments='Source rate $0.24/hour, the "Real-time Standard" row, Pro plan. Converted to $/k seconds: 0.24 / 3600 * 1000 = 0.0666666 recurring, stored as 0.066667. Speechmatics charges the same $0.24 for Batch Standard, so this is one of the few places in this catalog where batch and streaming genuinely cost the same. Both rows are kept so a caller naming either resolves.',
                pricing_source_url='https://www.speechmatics.com/pricing',
                provenance=Provenance(last_verified=datetime.date(2026, 8, 21)),
            ...
            ModelInfo(
                id='standard-batch',
                match=ClauseEquals(equals='standard-batch'),
                name='Standard (batch)',
                description='Faster, lower-cost operating point, pre-recorded. Same rate as streaming.',
                price_comments='Source rate $0.24/hour, the "Batch Standard" row, Pro plan. Converted to $/k seconds: 0.24 / 3600 * 1000 = 0.0666666 recurring, stored as 0.066667. Identical to the real-time Standard rate. Not a copy-paste: Speechmatics publishes the same $0.24 in both columns, unlike Enhanced which differs.',
                pricing_source_url='https://www.speechmatics.com/pricing',
                provenance=Provenance(last_verified=datetime.date(2026, 8, 21)),
                prices=ModelPrice(input_audio_kseconds=Decimal('0.066667')),
            ),
