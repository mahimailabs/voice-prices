...
providers: list[Provider] = [
    ...
    Provider(
        ...
        price_comments='Rime bills usage-based by characters (Starter plan). Official pricing page (https://rime.ai/pricing, model comparison) publishes per-1,000-characters rates: Mist v3 = $0.03 / 1K chars and Coda = $0.05 / 1K chars. These map directly to input_kchars (USD per 1,000 input characters). Starter includes ~3,000 free minutes; Enterprise is custom volume pricing (no published rate). Arcana was sunset on 2026-08-15 and is kept only as a deprecated entry at its last published $0.04 / 1K rate.',
        model_match=ClauseRegex(regex='^(coda|mistv2|mistv3|arcana|luna|rime-tts)$'),
        provider_match=ClauseContains(contains='rime'),
        staleness_threshold_days=60,
        models=[
            ModelInfo(
                id='arcana',
                match=ClauseEquals(equals='arcana'),
                name='Rime Arcana',
                description='Expressive conversational TTS model (vibes/expressive prosody). Sunset by Rime on 2026-08-15; retained as a deprecated entry for historical rates.',
                price_comments='Last published official rate (pre-sunset): $0.04 per 1,000 characters => input_kchars = 0.04. Arcana is no longer listed on the current pricing page (sunset 2026-08-15).',
            ...
            ModelInfo(
                ...
                name='Rime Coda',
                description='Flagship conversational TTS model for the most natural expression. Production-ready in 8 languages with 184 curated voices and sub-100ms cloud latency.',
                price_comments='Official Starter rate: $0.05 per 1,000 characters (~$0.05/minute) => input_kchars = 0.05.',
                pricing_source_url='https://rime.ai/pricing',
                provenance=Provenance(last_verified=datetime.date(2026, 8, 16)),
                prices=ModelPrice(input_kchars=Decimal('0.05')),
            ),
            ModelInfo(
                id='mistv2',
                match=ClauseEquals(equals='mistv2'),
                name='Rime Mist v2',
                description='Ultra-low-latency conversational TTS model (Mist family). Supports English and Spanish. Same per-character rate as the newer Mist v3.',
                price_comments='Official Mist rate: $0.03 per 1,000 characters (~$0.03/minute) => input_kchars = 0.03. Applies to the Mist family (v2 and v3).',
                pricing_source_url='https://rime.ai/pricing',
                provenance=Provenance(last_verified=datetime.date(2026, 8, 16)),
                prices=ModelPrice(input_kchars=Decimal('0.03')),
            ),
            ModelInfo(
                id='mistv3',
                match=ClauseEquals(equals='mistv3'),
                name='Rime Mist v3',
                description='Current-generation ultra-low-latency conversational TTS model (Mist family). English-only, ~37ms P50 time-to-first-audio in the cloud.',
                price_comments='Official Mist v3 rate: $0.03 per 1,000 characters (~$0.03/minute) => input_kchars = 0.03. Applies to the Mist family (v2 and v3).',
                pricing_source_url='https://rime.ai/pricing',
                provenance=Provenance(last_verified=datetime.date(2026, 8, 16)),
                prices=ModelPrice(input_kchars=Decimal('0.03')),
            ),
