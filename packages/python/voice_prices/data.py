...
providers: list[Provider] = [
    ...
    Provider(
        ...
        pricing_urls=['https://elevenlabs.io/pricing'],
        price_comments="ElevenLabs bills in credits, not directly in dollars per character. The rates in this catalog convert credits to dollars using ElevenLabs' Creator tier ($11/month for 121,000 credits ~= $0.0000909 per credit), which is the most common paid tier for API users. Per-model credit costs from ElevenLabs docs: Turbo v2.5 and Flash v2.5 use 0.5 credits/character (API discount), Multilingual v2 uses 1 credit/character. Consumers on Starter ($6/month for 30k credits, ~$0.0002/credit), Pro ($99/month for 600k credits, ~$0.000165/credit), or Scale ($299/month for 1.8M credits, ~$0.000166/credit) tiers should derive their own effective per-character rate from these conversions.",
        ...
        models=[
            ModelInfo(
                ...
                description='Low-latency multilingual TTS model. Optimized for real-time / streaming use cases. Same per-character credit rate as Turbo v2.5.',
                price_comments='0.5 credits/character at Creator tier ($0.0000909/credit) = $0.045/kchar.',
            ...
            ModelInfo(
                ...
                description='Full-fidelity multilingual TTS model. Higher per-character credit cost than Turbo/Flash; used when output quality matters more than latency.',
