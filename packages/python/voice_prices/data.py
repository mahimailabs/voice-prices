...
providers: list[Provider] = [
    ...
    Provider(
        ...
        models=[
            ...
            ModelInfo(
                id='flux-general-batch',
                match=ClauseEquals(equals='flux-general-batch'),
                name='Flux (batch)',
                description='Deepgram Flux prerecorded / batch transcription, English. Flux is primarily a real-time model; this is the prerecorded rate.',
                price_comments='Source rate $0.0077/minute (Pay As You Go prerecorded). Converted to $/k seconds: 0.0077 * 1000 / 60 ~= 0.128333.',
                pricing_source_url='https://deepgram.com/pricing',
                provenance=Provenance(last_verified=datetime.date(2026, 5, 29)),
            ...
            ModelInfo(
                ...
                price_comments="Source rate $0.0043/minute (prerecorded). Converted to $/k seconds: 0.0043 * 1000 / 60 ~= 0.071667. Nova-2 is a legacy model no longer listed in Deepgram's public pricing table; rate from independent sources. Verify before relying on it.",
                pricing_source_url='https://deepgram.com/pricing',
                provenance=Provenance(last_verified=datetime.date(2026, 5, 29)),
            ...
            ModelInfo(
                ...
                description='Deepgram Nova-3 prerecorded / batch STT, English / monolingual rate. Higher per-minute than streaming.',
                price_comments='Source rate $0.0077/minute. Converted to $/k seconds: 0.0077 * 1000 / 60 ~= 0.12833.',
                pricing_source_url='https://deepgram.com/pricing',
                provenance=Provenance(last_verified=datetime.date(2026, 5, 28)),
                prices=ModelPrice(input_audio_kseconds=Decimal('0.12833')),
            ),
            ModelInfo(
            ...
            ModelInfo(
                ...
                price_comments='Source rate $0.0092/minute. Converted to $/k seconds: 0.0092 * 1000 / 60 ~= 0.15333.',
                pricing_source_url='https://deepgram.com/pricing',
                provenance=Provenance(last_verified=datetime.date(2026, 5, 28)),
                prices=ModelPrice(input_audio_kseconds=Decimal('0.15333')),
            ),
        ],
    ),
    Provider(
    ...
    Provider(
        id='fal',
        name='fal.ai',
        api_pattern='https://(queue\\.)?fal\\.run',
        pricing_urls=['https://fal.ai/pricing'],
        price_comments="fal.ai is a model-hosting marketplace; it resells many third-party TTS models (ElevenLabs, MiniMax, F5-TTS, Chatterbox, etc.) through the fal Model API. Every model below bills per 1,000 input characters, and fal publishes that unit price directly on each model's page (see the per-model pricing_source_url). input_kchars is therefore the published dollar rate per 1,000 characters with no conversion needed. Rates verified 2026-08-16 from fal's official model pages (fal.ai/models/<endpoint-id>).",
        model_match=ClauseStartsWith(starts_with='fal-ai/'),
        provider_match=ClauseContains(contains='fal'),
        staleness_threshold_days=60,
        models=[
            ModelInfo(
                id='fal-ai/elevenlabs/tts/eleven-v3',
                match=ClauseEquals(equals='fal-ai/elevenlabs/tts/eleven-v3'),
                name='ElevenLabs TTS Eleven v3 (via fal)',
                description="ElevenLabs' Eleven v3 model served through the fal Model API. High-quality multilingual text-to-speech with voice control. Billed per 1,000 characters by fal.",
                price_comments='fal publishes $0.1 per 1000 characters for this endpoint; input_kchars = 0.1.',
                pricing_source_url='https://fal.ai/models/fal-ai/elevenlabs/tts/eleven-v3',
                provenance=Provenance(last_verified=datetime.date(2026, 8, 16)),
                prices=ModelPrice(input_kchars=Decimal('0.1')),
            ),
            ModelInfo(
                id='fal-ai/elevenlabs/tts/multilingual-v2',
                match=ClauseEquals(equals='fal-ai/elevenlabs/tts/multilingual-v2'),
                name='ElevenLabs TTS Multilingual v2 (via fal)',
                description="ElevenLabs' Multilingual v2 model served through the fal Model API. Full-fidelity multilingual text-to-speech. Billed per 1,000 characters by fal.",
                price_comments='fal publishes $0.1 per 1000 characters for this endpoint; input_kchars = 0.1.',
                pricing_source_url='https://fal.ai/models/fal-ai/elevenlabs/tts/multilingual-v2',
                provenance=Provenance(last_verified=datetime.date(2026, 8, 16)),
                prices=ModelPrice(input_kchars=Decimal('0.1')),
            ),
            ModelInfo(
                id='fal-ai/elevenlabs/tts/turbo-v2.5',
                match=ClauseEquals(equals='fal-ai/elevenlabs/tts/turbo-v2.5'),
                name='ElevenLabs TTS Turbo v2.5 (via fal)',
                description="ElevenLabs' Turbo v2.5 model served through the fal Model API. Low-latency multilingual text-to-speech for real-time use. Billed per 1,000 characters by fal.",
                price_comments='fal publishes $0.05 per 1000 characters for this endpoint; input_kchars = 0.05.',
                pricing_source_url='https://fal.ai/models/fal-ai/elevenlabs/tts/turbo-v2.5',
                provenance=Provenance(last_verified=datetime.date(2026, 8, 16)),
                prices=ModelPrice(input_kchars=Decimal('0.05')),
            ),
            ModelInfo(
                id='fal-ai/f5-tts',
                match=ClauseEquals(equals='fal-ai/f5-tts'),
                name='F5 TTS (via fal)',
                description='F5-TTS diffusion model served through the fal Model API. Zero-shot voice cloning from a single reference audio sample. Billed per 1,000 characters by fal.',
                price_comments='fal publishes $0.05 per 1000 characters for this endpoint; input_kchars = 0.05.',
                pricing_source_url='https://fal.ai/models/fal-ai/f5-tts',
                provenance=Provenance(last_verified=datetime.date(2026, 8, 16)),
                prices=ModelPrice(input_kchars=Decimal('0.05')),
            ),
            ModelInfo(
                id='fal-ai/minimax/speech-2.6-turbo',
                match=ClauseEquals(equals='fal-ai/minimax/speech-2.6-turbo'),
                name='MiniMax Speech 2.6 Turbo (via fal)',
                description='MiniMax Speech-2.6 Turbo model served through the fal Model API. Fast multilingual text-to-speech with interjection and pause tags. Billed per 1,000 characters by fal.',
                price_comments='fal publishes $0.06 per 1000 characters for this endpoint; input_kchars = 0.06.',
                pricing_source_url='https://fal.ai/models/fal-ai/minimax/speech-2.6-turbo',
                provenance=Provenance(last_verified=datetime.date(2026, 8, 16)),
                prices=ModelPrice(input_kchars=Decimal('0.06')),
            ),
            ModelInfo(
                id='fal-ai/minimax/speech-2.8-hd',
                match=ClauseEquals(equals='fal-ai/minimax/speech-2.8-hd'),
                name='MiniMax Speech 2.8 HD (via fal)',
                description='MiniMax Speech-2.8 HD model served through the fal Model API. High-definition multilingual text-to-speech with emotion control. Billed per 1,000 characters by fal.',
                price_comments='fal publishes $0.1 per 1000 characters for this endpoint; input_kchars = 0.1.',
                pricing_source_url='https://fal.ai/models/fal-ai/minimax/speech-2.8-hd',
                provenance=Provenance(last_verified=datetime.date(2026, 8, 16)),
                prices=ModelPrice(input_kchars=Decimal('0.1')),
            ),
            ModelInfo(
                id='fal-ai/minimax/speech-2.8-turbo',
                match=ClauseEquals(equals='fal-ai/minimax/speech-2.8-turbo'),
                name='MiniMax Speech 2.8 Turbo (via fal)',
                description='MiniMax Speech-2.8 Turbo model served through the fal Model API. Speed-optimized multilingual text-to-speech. Billed per 1,000 characters by fal.',
                price_comments='fal publishes $0.06 per 1000 characters for this endpoint; input_kchars = 0.06.',
                pricing_source_url='https://fal.ai/models/fal-ai/minimax/speech-2.8-turbo',
                provenance=Provenance(last_verified=datetime.date(2026, 8, 16)),
                prices=ModelPrice(input_kchars=Decimal('0.06')),
            ),
        ],
