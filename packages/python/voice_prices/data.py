    ...
    Provider(
        ...
        models=[
            ...
            ModelInfo(
                ...
                description='Google Cloud Text-to-Speech Neural2 voices use deep neural networks to produce natural-sounding speech across a wide range of languages and voices.',
                price_comments='Published rate US$0.000016 per character (US$16 per 1 million characters). 16 / 1000 = 0.016 per 1,000 characters.',
            ...
            ModelInfo(
                ...
                description='Google Cloud Text-to-Speech Polyglot (Preview) voices let a single voice speak multiple languages from one multilingual model, for cross-lingual applications.',
                price_comments='Published rate US$0.000016 per character (US$16 per 1 million characters). 16 / 1000 = 0.016 per 1,000 characters.',
                pricing_source_url='https://cloud.google.com/text-to-speech/pricing#legacy-tts-models',
                provenance=Provenance(last_verified=datetime.date(2026, 8, 16)),
                prices=ModelPrice(input_kchars=Decimal('0.016')),
            ...
            ModelInfo(
                ...
                description='Google Cloud Text-to-Speech Standard voices are the baseline concatenative synthesis voices, available in many languages at the lowest cost tier.',
                price_comments='Published rate US$0.000004 per character (US$4 per 1 million characters). 4 / 1000 = 0.004 per 1,000 characters.',
                pricing_source_url='https://cloud.google.com/text-to-speech/pricing#legacy-tts-models',
                provenance=Provenance(last_verified=datetime.date(2026, 8, 16)),
            ...
            ModelInfo(
                ...
                description='Google Cloud Text-to-Speech Studio voices are premium, high-fidelity voices for long-form narration and professional audio, with the most natural intonation.',
                price_comments='Published rate US$0.00016 per character (US$160 per 1 million characters). 160 / 1000 = 0.16 per 1,000 characters.',
                pricing_source_url='https://cloud.google.com/text-to-speech/pricing#legacy-tts-models',
                provenance=Provenance(last_verified=datetime.date(2026, 8, 16)),
            ...
            ModelInfo(
                ...
                description='Google Cloud Text-to-Speech WaveNet voices use a deep generative model of audio to produce more natural-sounding speech than the Standard concatenative voices.',
                price_comments='Published rate US$0.000004 per character (US$4 per 1 million characters). 4 / 1000 = 0.004 per 1,000 characters. WaveNet is listed at the same per-character rate as Standard on the pricing page, which is why the two rows carry equal rates.',
                pricing_source_url='https://cloud.google.com/text-to-speech/pricing#legacy-tts-models',
                provenance=Provenance(last_verified=datetime.date(2026, 8, 16)),
                prices=ModelPrice(input_kchars=Decimal('0.004')),
            ),
