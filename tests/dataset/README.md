This folder is for testing voice-prices against a dataset of real requests.
...
- For each body, for all providers and extractors (API flavours) possible, use voice-prices to:
  - Extract usage
  - Calculate prices
