...
| <sup>`estimated`</sup> | The rate is the vendor's own approximation of a bill charged in another unit. Use it to compare vendors and plan capacity, not to reconcile a bill. |
